...
Called from Swift via PythonKit:
    let runner = Python.import("runner")
...
# on iOS that surfaces as an actual browser window opening on top of the app.
# We always want HTML returned via to_html() (see Priority 2 below), never
